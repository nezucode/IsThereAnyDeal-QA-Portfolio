...
### LOG_SC07_TC27 - Verify login using a Steam account
...
| 2 | Login using a valid Steam account | User is successfully signed in and redirected to the homepage | ✅ Passed |
